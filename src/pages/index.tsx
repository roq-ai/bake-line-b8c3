...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Bake Line`}</title>

        <meta
          name="description"
          content="Bake Line - Streamlining Your Bakery Business. A comprehensive management system for both admin and user. Admins can effortlessly add items, photos, types, and prices. Users enjoy a seamless shopping experience with options to add products to cart and purchase. Your bakery business simplified."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1517433367423-c7e5b0f35086?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxiYWtlcnl8ZW58MHx8fHwxNjk1ODI2MTMzfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@mitifotos?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Miti`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Bake Line - Streamlining Your Bakery Business. A comprehensive management system for both admin and user. Admins can effortlessly add items, photos, types, and prices. Users enjoy a seamless shopping experience with options to add products to cart and purchase. Your bakery business simplified.`}
            </Text>
            <Box
